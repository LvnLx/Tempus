...
extern "C" {
    ...
    Java_com_lvnlx_tempus_MainActivity_addSubdivision(JNIEnv* env, jobject, jstring key, jint option, jfloat volume) {
    ...
    JNIEXPORT void JNICALL
    Java_com_lvnlx_tempus_MainActivity_setSubdivisionOption(JNIEnv* env, jobject, jstring key, jint option) {
        metronome.setSubdivisionOption(env->GetStringUTFChars(key, nullptr), option);
    }

    JNIEXPORT void JNICALL
    Java_com_lvnlx_tempus_MainActivity_setSubdivisionVolume(JNIEnv* env, jobject, jstring key, jfloat volume) {
